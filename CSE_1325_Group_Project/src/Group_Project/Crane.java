...
/*
 * The crane class extends the dock class, and has all
 * the same variablea as parent class.
 */
public class Crane extends Dock {
	 ...
	 * dockSymbol, which will be set to a default value of 'C'.
	 */
	public Crane(String dockName, char dockSection, int dockNumber,
	 ...
	 * 
	 * toString() method formats each of the crane's variables separated by
	...
	/*
	 * Neatly displays all of the crane's info.
	 */
	@Override
	public void displayDockInfo() {
		...
		System.out.printf("Crane number: %c%d \n", dockSection, dockNumber);
